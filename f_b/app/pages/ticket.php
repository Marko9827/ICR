<?php if ($this->isLoged()) {
    $sql2 = $this->Query("SELECT * FROM rezerved WHERE rezerved.flight_id = $_GET[id]");
                    ...
                    <div class="col-md-15 col-lg-8 margin-auto">
                        <form class="needs-validation" novalidate>
                            ...
                            <div class="row g-3">
                                ...
                                <button onclick="ICR.ui.checkout.ticket(<?php echo $_GET['id']; ?>,'ticked_edit');" class="btn_twos col-md-3 w-100 btn btn-primary btn-lg checked_disabled_chk" disabled type="button"><i class="bi bi-airplane"></i> Save</button>
                                <button onclick="ICR.ui.checkout.ticket(<?php echo $_GET['id']; ?>,'ticked_del');" class="btn_twos col-md-3 w-100 btn btn-danger btn-lg checked_disabled_chk" disabled type="button"><i class="bi bi-trash"></i> Delete</button>
                            </div>
                        </form>
                    </div>
                </div>
