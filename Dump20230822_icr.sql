...
CREATE TABLE `flights` (
  ...
  `descr` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `flights` VALUES (0,'Russia','Belgrade','Moskow','Serbia Airport','Russia Airport','Best food in the plane','all','A',900,'14/12/2023',0,0),(1,'Egypt','Belgrade','Giza','Serbia Airport','Egypt Airport','Best destination for your wakation','all','B',1500,'03/02/2023',0,0);
...
CREATE TABLE `rezerved` (
  `rezerved_id` int NOT NULL,
  `user_id` int NOT NULL,
  `time` int NOT NULL,
  PRIMARY KEY (`rezerved_id`),
  KEY `rezerved_user_id_fkey` (`user_id`),
  CONSTRAINT `rezerved_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (0,NULL,'Pera','pera@test.com',NULL,'Belgrade',34234234,0,0,0);
...
-- Dump completed on 2023-08-22 23:31:56
